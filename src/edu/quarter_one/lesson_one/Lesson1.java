...
public class Lesson1 {
    ...
    public static void taskFive(int a) {
        ...
        if (c1 == c2) System.out.println(a + " год является високосным");
        if (b1 == b2) System.out.println(a + " год не является високосным");
        if (a1 == a2) System.out.println(a + " год является високосным");
